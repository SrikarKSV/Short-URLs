...
})({"5lB8Q":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f101d3dbd127cf33933992f48f7cc16f";
  ...
  ws.onmessage = function (event) {
    ...
    if (data.type === 'update') {
      ...
      assets.forEach(function (asset) {
        var didAccept = asset.type === 'css' || asset.type === 'js' && hmrAcceptCheck(module.bundle.root, asset);
        if (didAccept) {
          handled = true;
        }
      });
...
},{}],"N9Ohe":[function(require,module,exports) {
var _flatpickr = require('flatpickr');
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _flatpickrDefault = _parcelHelpers.interopDefault(_flatpickr);
require('flatpickr/dist/flatpickr.css');
require('../css/main.css');
var allRadioBtn = document.querySelectorAll('input[type="radio"]');
var customExpiryDateDiv = document.querySelector('.custom-expiry-date');
var extraLinks = document.querySelector('.extra-links');
var customExpiryDate = document.querySelector('.enter-custom');
var form = document.querySelector('.form');
allRadioBtn.forEach(function (radioBtn) {
  radioBtn.addEventListener('input', function (e) {
    var toggleOpen = e.target.matches('#custom');
    toggleOpen ? customExpiryDateDiv.classList.add('custom-expiry-date--expand') : customExpiryDateDiv.classList.remove('custom-expiry-date--expand');
  });
});
// Checking values before submission
form.addEventListener('submit', function (e) {
  e.preventDefault();
  var urls = e.target.url.value.split(',').map(function (url) {
    return url.trim();
  });
  if (urls.length > 10) {
...
_flatpickrDefault.default('#datetime', {
  enableTime: true,
  minDate: Date.now(),
...
},{"flatpickr":"4DB66","flatpickr/dist/flatpickr.css":"6ZRmv","../css/main.css":"35TmZ","@parcel/transformer-js/lib/esmodule-helpers.js":"J90fb"}],"4DB66":[function(require,module,exports) {
var define;
...
},{}],"6ZRmv":[function() {},{}],"35TmZ":[function() {},{}],"J90fb":[function(require,module,exports) {
"use strict";
...
},{}]},["5lB8Q","N9Ohe"], "N9Ohe", "parcelRequire2eed")
